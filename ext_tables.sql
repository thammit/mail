...
(
    ...
    static_list       int(11) unsigned DEFAULT '0' NOT NULL,
    list              mediumblob,
    csv               tinyint(4) unsigned DEFAULT '0' NOT NULL,
...
(
    ...
    response_type    tinyint(4) unsigned DEFAULT '0' NOT NULL,
    format_sent      tinyint(4) unsigned DEFAULT '0' NOT NULL,
    url_id           tinyint(4) unsigned DEFAULT '0' NOT NULL,
    return_content   mediumblob NULL,
    return_code      smallint(6) unsigned DEFAULT '0' NOT NULL,
    PRIMARY KEY (uid),
