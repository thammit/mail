...
return [
    'ctrl' => [
        ...
        'delete' => 'deleted',
        'iconfile' => 'EXT:mail/Resources/Public/Icons/mail.gif',
        'type' => 'type',
    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.type.I.0', '0'],
                    ['LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.type.I.1', '1'],
    ...
    'types' => [
        '0' => ['showitem' => '
			--div--;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.tab1, type,sys_language_uid, page, plainParams, HTMLParams, attachment,
            ...
            --div--;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.tab3, sendOptions, includeMedia, flowedFormat, use_rdct, long_link_mode, authcode_fieldList, scheduled
		'],
        '1' => ['showitem' => '
            --div--;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.tab1, type, page, plainParams;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.plainParams.ALT.1, HTMLParams;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.HTMLParams.ALT.1, attachment,
            --div--;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.tab2, subject, --palette--;;from, --palette--;Reply-to;reply, return_path, organisation, priority, encoding,
            --div--;LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail.tab3, sendOptions, includeMedia, flowedFormat, use_rdct, long_link_mode, authcode_fieldList, scheduled
		'],
        '2' => ['showitem' => '
