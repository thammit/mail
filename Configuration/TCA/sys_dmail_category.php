...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail_category',
        'label' => 'category',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'EXT:mail/Resources/Public/Icons/icon_tx_directmail_category.gif',
    ],
    'columns' => [
        'sys_language_uid' => [
        ...
        'old_cat_number' => [
            'label' => 'LLL:EXT:mail/Resources/Private/Language/locallang_tca.xlf:sys_dmail_category.old_cat_number',
            'l10n_mode' => 'exclude',
            'config' => [
                'type' => 'input',
                'size' => '2',
